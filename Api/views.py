...
from .serializers import ProductDetailSerializer,ProductListSerializer,CategoryListSerializer,CategoryDetailSerializer,CartItemSerializer,CartSerializer,Review,ReviewSerializer,UserSerializer,Wishlist,WishlistSerializer
...
def add_review(request):
    ...
    if Review.objects.filter(product=product, user=user).exists():
        return Response({"error": "You already made a review for this product"}, status=400)
...
def create_checkout_session(request):
    ...
    try:
        checkout_session = stripe.checkout.Session.create(
            ...
            line_items=[
            ...
            ] + [
                {
                    'price_data': {
                        ...
                        'unit_amount':  50000, # This is 500.00 KES
                    },
                    'quantity': 1,
                }
            ],
            ...
            success_url="https://eShop-self.vercel.app/success",
            cancel_url="https://eShop-self.vercel.app/failed",
